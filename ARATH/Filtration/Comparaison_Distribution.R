...
source('ARATH/Filtration/Fonction/pretraitement.seuil.R')
source('ARATH/Filtration/Fonction/pretraitement.sets.R')
source('ARATH/Filtration/Fonction/no.pretraitement.R')
