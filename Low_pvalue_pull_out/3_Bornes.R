...
ind_levures <- c()
for (prot in split_data){if (prot[["Species"]][1] == "levure"){ind_levures<-rbind(ind_levures,which(split_data==prot))}}
...
save(df_plot,file='Low_pvalue_pull_out/save/df_plot.RData')
