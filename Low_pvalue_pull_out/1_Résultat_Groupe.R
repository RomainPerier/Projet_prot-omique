...
save(res_ordered_pvalue,file="Low_pvalue_pull_out/save/res_ordered_pvalue.RData")
res_ordered_pvalue <- res_ordered_pvalue[447:]

## On retire les 446 premières p-valeurs qui sont des levures---------



save(proteom,file='Low_pvalue_pull_out/save/proteom.RData')
save(res_ordered,file='Low_pvalue_pull_out/save/res_ordered.RData')
rm(res)
...
save(split_data, file = "Low_pvalue_pull_out/save/split_data.RData")
...
save(pval,line_sorted_by_pval,pval_sorted,file='Low_pvalue_pull_out/save/pval.RData')
...
save(split_data_pvalue, file = "Low_pvalue_pull_out/save/split_data_pvalue.RData")
rm(prot)
